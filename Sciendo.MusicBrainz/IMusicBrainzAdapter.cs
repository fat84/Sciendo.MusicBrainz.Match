...
namespace Sciendo.MusicBrainz
{
    ...
    {
        void LinkToExisting(IEnumerable<FileAnalysed> filesAnalysed, bool forceCreate, bool testOnly);

        void CreateNew(IEnumerable<FileAnalysed> filesAnalysed, bool testOnly);
